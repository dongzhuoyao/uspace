...
def main(resolution=256):
    ...
    if args.split == "train":
        datas = MSCOCODatabase(
            root="assets/datasets/coco/train2014",
            annFile="assets/datasets/coco/annotations/captions_train2014.json",
            size=resolution,
        )
        save_dir = f"assets/datasets/coco{resolution}_features_withcaptioncontext/train"
    elif args.split == "val":
        datas = MSCOCODatabase(
        ...
        save_dir = f"assets/datasets/coco{resolution}_features_withcaptioncontext/val"
        ...
        save_dir = f"assets/datasets/coco{resolution}_features_withcaptioncontext/debug"
    else:
