...
from lfm_dataset.metfaces_from1024 import MetFaces_From1024
...
def main(resolution=256, debug=False, ds_name='metfaces', _feat_h5_path='assets/datasets/metfaces256_features.h5'):
    parser = argparse.ArgumentParser()
    

    dataset = MetFaces_From1024(root="~/data_hhd/metfaces/images_size256", size=256)
