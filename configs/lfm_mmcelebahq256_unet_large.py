...
def get_config():
    ...
    config.dissection = d(
        ...
        n_samples=1000,
        mini_batch_size=10,
        ckpt_path_to_dissect="workdir/lfm_mmcelebahq256_unet_large/v2-unet-mmcelebahq256_features_withcaptioncontext-unet-batch_size=96/ckpts/30000.ckpt/nnet.pth",
